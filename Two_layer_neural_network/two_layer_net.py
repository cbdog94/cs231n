...
# `cs231n/classifiers/neural_net.py` to represent instances of our
# network. The network parameters are stored in the instance variable
# `self.params` where keys are string parameter names and values are numpy
# arrays. Below, we initialize toy data and a toy model that we will use
# to develop your implementation.
...
# the loss with respect to the variables `W1`, `b1`, `W2`, and `b2`. Now
# that you (hopefully!) have a correctly implemented forward pass, you can
# debug your backward pass using a numeric gradient check:
